...
let monTuple : [string, number, boolean] = ["test", 12345, true]
console.log(`monTuple ${monTuple}`);

// Déclaration d'un variables avec un typage explicite pour un objet
let monObjet : {nom : string, age : number} = {nom : "toto", age : 50}
...
let maVariableNonDefinie : string | undefined
