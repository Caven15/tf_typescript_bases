...
let fruits : string[] = ["promme", 'Poire', "Banane"]
...
let etudiant : any = {nom : "Jhon", age : 35, grade : "Medior"}
...
let prenoms : string[] = ["Jhon", "Bob", "Tom", "Snoop"] 
...
function motDePasseValide(motDePasse : string) : boolean{
